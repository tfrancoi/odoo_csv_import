...
from lib.transform import ProductProcessorV10
...
processor.process_attribute_data(attribute_list, ATTRIBUTE_PREFIX, 'data%sproduct.attribute.csv' % os.sep, { 'worker' : 4, 'batch_size' : 10, 
                                                                                                              'context' : context})
